    ...
    return (
      <React.Fragment>
        ...
        <td style={{ borderTop: `1px solid` }}>
          ...
          <td style={{ borderTop: `1px solid` }}>${record.amount}</td>
          <td style={{ borderTop: `1px solid` }} className="text-danger">
          ...
          <td style={{ borderTop: `1px solid` }}>
           ...
           <td style={{ borderTop: `1px solid`, width: "120px" }}>
