...
class NewPatients extends Component {
  ...
  clearSearch = () => {
    this.setState(
      ...
      () => {
        this.getNewPatients(this.state.fields);
      }
    );
  };
        ...
        if (response && params.export === true) {
          ...
          try {
            ...
            if (typeof window.navigator.msSaveBlob !== "undefined") {
              ...
              a.href = downloadUrl;
              a.download = "report-new-patients.pdf";
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        <Helmet>
          <title>New Patients : iMagDent</title>
        </Helmet>
        <Row>
          <Col xl={12}>
            <Card>
              <CardHeader>
                <Row>
                  <Col xs={6}>
                    <Form>
                      <InputGroup>
                        <strong style={{ fontSize: 20 }}>New Patients</strong>
                      </InputGroup>
                    </Form>
                  </Col>
                ...
                <Search
                  ...
                  searchRecord={this.getNewPatients}
              ...
              <CardBody>
                ...
                >
                  ...
                  {this.state.fields["location_id"] && (
                    ...
                    >
                      <strong>
                        {this.state.fields["location_id"]["label"]} - New Users
                      </strong>
                    </Alert>
                  )}
                    ...
                    <thead>
                      <tr class="patient-list">
                        ...
                        <th
                          scope="col"
                          className="border-top-0 sortable"
                          onClick={(event) => this.sortRecord(event, "dob")}
                        >
                          Birth Date
                        </th>
                        <th
                          scope="col"
                          className="border-top-0 sortable"
                          onClick={(event) => this.sortRecord(event, "age")}
                        >
                          Age
                        </th>
                        <th
                          scope="col"
                          className="border-top-0 sortable"
                          onClick={(event) => this.sortRecord(event, "phone")}
                        >
                          Phone
                        </th>
                        <th
                          scope="col"
                          className="border-top-0 sortable"
                          onClick={(event) => this.sortRecord(event, "city")}
                        >
                          City
                        </th>
                        <th
                          scope="col"
                          className="border-top-0 sortable"
                          onClick={(event) => this.sortRecord(event, "state")}
                        >
                          State
                        </th>
                        <th
                          scope="col"
                          className="border-top-0 sortable"
                          onClick={(event) => this.sortRecord(event, "sex")}
                        >
                          Sex
                        </th>
                        <th
                          ...
                          className="border-top-0 sortable"
                          onClick={(event) =>
                            this.sortRecord(event, "added_on")
                          }
                        >
                          Added On
                        </th>
...
export default connect(mapStateToProps)(NewPatients);
