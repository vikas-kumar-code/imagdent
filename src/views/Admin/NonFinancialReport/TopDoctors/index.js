...
class TopDoctors extends Component {
  ...
  clearSearch = () => {
    this.setState(
      ...
      () => {
        this.getDoctors(this.state.fields);
      }
    );
  };
        ...
        if (response && params.export === true) {
          ...
          try {
            ...
            if (typeof window.navigator.msSaveBlob !== "undefined") {
              ...
              a.href = downloadUrl;
              a.download = "report-top-doctors.pdf";
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        <Helmet>
          <title>Top Doctors : iMagDent</title>
        </Helmet>
        <Row>
          <Col xl={12}>
            <Card>
              <CardHeader>
                <Row>
                  <Col xs={6}>
                    <Form>
                      <InputGroup>
                        <strong style={{ fontSize: 20 }}>Top Doctors</strong>
                      </InputGroup>
                    </Form>
                  </Col>
              ...
              <CardBody>
                ...
                >
                  ...
                  <Table responsive className="table-striped">
                    <thead>
                      <tr>
                        ...
                        <th
                          ...
                          className="border-top-0 sortable"
                          onClick={(event) =>
                            this.sortRecord(event, "username")
                          }
                        >
                          Username
                        </th>
                    ...
                    <tbody>
                      {this.state.doctors.length > 0
                        ? this.state.doctors.map((c, index) => (
                            <Doctor
                              record={c.doctor}
                              key={`key-user-${index}`}
                            />
...
export default connect(mapStateToProps)(TopDoctors);
