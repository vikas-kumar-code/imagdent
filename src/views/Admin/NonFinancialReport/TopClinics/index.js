...
class TopClinics extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fields: {
  ...
  clearSearch = () => {
    this.setState(
      ...
      () => {
        this.getClinics(this.state.fields);
      }
    );
  };
        ...
        if (response && params.export === true) {
          ...
          try {
            ...
            if (typeof window.navigator.msSaveBlob !== "undefined") {
              ...
              a.href = downloadUrl;
              a.download = "report-top-clinics.pdf";
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        <Helmet>
          <title>Top Clinics : iMagDent</title>
        </Helmet>
        <Row>
          <Col xl={12}>
            <Card>
              <CardHeader>
                <Row>
                  <Col xs={6}>
                    <Form>
                      <InputGroup>
                        <strong style={{ fontSize: 20 }}>Top Clinics</strong>
                      </InputGroup>
                    </Form>
                  </Col>
              ...
              <CardBody>
                ...
                >
                  ...
                  <Table responsive className="table-striped">
                    ...
                    <tbody>
                      {this.state.clinics.length > 0
                        ? this.state.clinics.map((c, index) => (
                            <Clinic
                              record={c.clinic}
                              key={`key-user-${index}`}
                            />
...
export default connect(mapStateToProps)(TopClinics);
