...
class CancelledAppointments extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fields: {
  ...
  clearSearch = () => {
    this.setState(
      ...
      () => {
        this.getCancelledAppointment(this.state.fields);
      }
    );
  };
  ...
  getCancelledAppointment = (fields) => {
        ...
        if (response && params.export === true) {
          ...
          try {
            ...
            if (typeof window.navigator.msSaveBlob !== "undefined") {
              ...
              a.href = downloadUrl;
              a.download = "report-cancelled-appointments.pdf";
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn">
        <Helmet>
          <title>Cancelled Apppointments : iMagDent</title>
        </Helmet>
        <Row>
          <Col xl={12}>
            <Card>
              <CardHeader>
                ...
                <Search
                  ...
                  heading="Search Cancelled Appointments"
                  searchFields={this.state.searchFields}
                  updateSearchFields={this.updateSearchFields}
                  searchRecord={this.getCancelledAppointment}
              ...
              <CardBody>
                ...
                >
                  ...
                  {this.state.fields["location_id"] && (
                    ...
                    >
                      <strong>
                        {this.state.fields["location_id"]["label"]} - Cancelled
                        Appointments
                      </strong>
                    </Alert>
                  )}
                    ...
                    <thead>
                      <tr>
                        <th
                          ...
                          onClick={(event) => this.sortRecord(event, "id")}
                        >
                          ID
                        </th>
                        <th
                        ...
                        <th
                          ...
                          className="border-top-0 sortable"
                          onClick={(event) =>
                            this.sortRecord(event, "patient-name")
                          }
                        >
                          Patient Name
                        </th>
                        ...
                        <th
                          ...
                          className="border-top-0 sortable"
                          onClick={(event) =>
                            this.sortRecord(event, "appointment-date")
                          }
                        >
                          Appointment Date
                        </th>
                    ...
                    <tbody>
                      {this.state.cases.length > 0
                        ? this.state.cases.map((c, index) => (
                            <Appointment record={c} key={`key-user-${index}`} />
                          ))
                        : !this.state.isloader && (
                            <tr>
                              <td key={0} colSpan="9">
...
export default connect(mapStateToProps)(CancelledAppointments);
